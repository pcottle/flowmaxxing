...
export default function WaterMaterial()
{
    const material = new THREE.ShaderMaterial({
        uniforms:
        {
            ...
            uWakeHeading: { value: new THREE.Vector2(0, - 1) },
            uWakeTrail: { value: Array.from({ length: 12 }, () => new THREE.Vector4(0, 0, - 1000, 0)) },
            uWakeSpread: { value: 0.38 },
            uWakeLength: { value: 7 },
            uWakeLineWidth: { value: 0.22 },
            uWakeTrailRadius: { value: 0.55 },
            uWakeTrailLife: { value: 1.6 },
            uWakeMaxDistance: { value: 24 },
